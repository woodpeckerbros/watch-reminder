...
public class UiText {
    ...
    static {
        ...
        put("נכון — כך תתקדמו לשאלה הבאה", "Correct — this advances to the next question");
        put("לא נכון — נסו שוב", "Incorrect — try again");
        put("עכשיו יש לחזור על הרצף בעזרת ארבעת כפתורי הצבע", "Now repeat the sequence using the four color buttons");
        put("נסו את השעון", "Try this alarm");
        ...
        put("חלון השכמה חכם", "Smart wake window");
        put("דקות לפני שעת ההשכמה", "Minutes before wake-up");
        put("נודניק", "Snooze");
        put("כל כמה דקות", "Interval in minutes");
        put("מספר פעמים", "Number of times");
        put("0 פעמים מבטל את אפשרות הנודניק", "0 disables snooze");
        put("רטט וצלצול", "Vibration and sound");
        put("עוצמה עדינה", "Gentle intensity");
        put("עוצמה בינונית", "Medium intensity");
        put("עוצמה חזקה", "Strong intensity");
        put("משך ההתראה בשניות", "Alarm duration in seconds");
        put("צריך לבחור לפחות יום אחד", "Select at least one day");
        put("השעון המעורר נשמר", "Smart Alarm saved");
