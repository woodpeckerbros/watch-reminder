...
public final class SmartAlarmReceiver extends BroadcastReceiver {
    ...
    @Override public void onReceive(Context context, Intent intent) {
        ...
        fire(context, targetAt, intent.getStringExtra("reason"));
    }

    public static void fire(Context context, long targetAt, String reason) {
        ...
        SmartWakeMonitoringService.stop(context);
        if (!"deadline".equals(reason)) SmartAlarmScheduler.cancelDeadline(context);
        ...
        PendingIntent pending = PendingIntent.getActivity(context, 0x534d5703, activity,
        ...
        manager.notify(0x534d5704, notification);
        SmartAlarmRingingService.start(context);
        try {
