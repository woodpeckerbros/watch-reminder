...
public class BlessingReminderComplicationService extends ComplicationDataSourceService {
    ...
    public void onComplicationActivated(int complicationInstanceId, ComplicationType type) {
        ComplicationRefresh.requestActivated(this, BlessingReminderComplicationService.class,
    ...
    private ComplicationData jewishModeOffData(ComplicationType type) {
        ...
        String description = getString(R.string.ui_enable_jewish_mode_blessing);
        if (type.equals(ComplicationType.SHORT_TEXT)) {
            return new ShortTextComplicationData.Builder(
