...
- שינוי אחרון (01/09): תיקון רשימת הגיבויים בטלפון — הסריקה עוברת דרך `MediaStore.Files` הכללי, ללא סינון SQL מוקדם שעלול להחזיר רשימה ריקה, עם fallback ל־Downloads ומניעת כפילויות. נבנה APK debug בהצלחה.
