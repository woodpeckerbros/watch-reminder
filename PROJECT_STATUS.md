...
- נוספו הרשאות `WAKE_LOCK` ו-`REQUEST_IGNORE_BATTERY_OPTIMIZATIONS`, ונוספה אזהרה לחיצה במסך הראשי שמובילה לאישור פעילות ברקע/אי-הגבלת סוללה כדי לשפר אמינות תזכורות אחרי איפוס או התקנה מחדש.
- תוקנה פתיחת מסך אי-הגבלת סוללה: במקום להסתמך על בקשת exemption ספציפית שלא נפתחת בחלק משעוני Wear OS, הכפתור פותח את מסך Battery Optimization הכללי ונופל למסך פרטי האפליקציה אם המסך הכללי לא זמין.
