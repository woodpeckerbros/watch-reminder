...
- ניסוי 02/09: הגדרת opt-in "גיבוי רטט של השעון" מנסה ליצור מראש דרך `ACTION_SET_ALARM` אזעקת מערכת שקטה עם רטט לשעת היעד. הגשר מופעל רק כש־Wear OS חושף פעילות Clock ישירה ל־API הציבורי; אם יש רק Resolver, הוא מדלג כדי שלא ייפתח חלון בחירה באמצע התראה/נודניק. ב־OnePlus Watch 3 הנוכחי אין פעילות ציבורית ישירה, ולכן אין עדיין גיבוי רטט זה.
