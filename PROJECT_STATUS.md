...
- שינוי 02/09: נוספה הגדרת opt-in "גיבוי רטט של השעון". לאחר סיום התראת Smart Alarm ללא טיפול, Zmanio עוצרת את המשוב שלה ומפעילה טיימר מערכת חד־פעמי של שנייה דרך ACTION_SET_TIMER; הצליל והרטט של הטיימר כפופים להגדרות השעון.
- תיקון 02/09: הפעלת טיימר המערכת הועברה מ־Activity ל־SmartAlarmAutoSnoozeReceiver. כך סגירת מסך ההתראה באותו רגע אינה מבטלת את ה־Handler לפני הפעלת ה־fallback.
