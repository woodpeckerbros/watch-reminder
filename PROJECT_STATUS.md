...
- ניסוי 02/09: הגדרת opt-in "גיבוי רטט של השעון" יוצרת מראש דרך `ACTION_SET_ALARM` אזעקת מערכת שקטה עם רטט לשעת היעד. היא מתוזמנת בתחילת חלון ההשכמה וגם לכל נודניק, ומבוטלת לפי תווית ייחודית כאשר Zmanio מכובה/נדחית; טיימר המערכת המאוחר הוסר.
