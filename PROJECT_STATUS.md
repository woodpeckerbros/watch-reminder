...
- תיקון צומות ושפות ‏22/09: מסך זמני היום מחשב צום לפי היום שנבחר בפדפדוף, מציג יציאה רגילה ויציאה לפי ר״ת, ומשתמש בזמני Zmanim מבוססי מיקום; התראת ימים יהודיים מרעננת את שם החג לפי השפה שנבחרה בזמן המסירה כדי למנוע ערבוב עברית/אנגלית. `:app:testDebugUnitTest :app:assembleDebug` עברו. ממתין ל־commit/push.
