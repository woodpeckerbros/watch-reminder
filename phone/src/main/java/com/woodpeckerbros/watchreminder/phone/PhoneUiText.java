...
final class PhoneUiText {
    ...
    static {
        ...
        put("ניעור היד", "Shake wrist"); put("הליכה", "Walk");
        ...
        put("הצגת דוגמת חשבון", "Preview math task"); put("הצגת דוגמת זיכרון", "Preview memory task");
        put("בדיקת ערנות לאחר הכיבוי", "Wake-up check after dismissal");
        put("בדיקת ערנות אחרי דקות", "Wake-up check after minutes");
        put("דוגמת תרגיל חשבון", "Math task preview"); put("דוגמת תרגיל זיכרון", "Memory task preview");
        put("רמה", "Level"); put("שאלה אחת", "One question"); put("שתי שאלות רצופות", "Two questions in a row");
        put("שלוש שאלות רצופות", "Three questions in a row"); put("הצבעים מוצגים אחד אחרי השני, ואז חוזרים על הרצף", "Colors appear one by one, then you repeat the sequence");
        put("אורך הרצף", "Sequence length");
