        ...
        try {
            root.put("type", "watch-reminder-backup")
                    ...
                    .put("settings", new JSONObject()
                            ...
                            .put("waterRemindersEnabled", false)
                            .put("waterMode", "daily_target")
                            .put("waterDailyTargetMl", 2000)
                            .put("waterAmountMl", 250)
                            .put("waterIntervalMinutes", 120)
                            .put("waterStartHour", 8)
                            .put("waterStartMinute", 0)
                            .put("waterEndHour", 22)
                            .put("waterEndMinute", 0)
                            .put("language", "auto")
