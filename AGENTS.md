...
- After every meaningful change, update `PROJECT_STATUS.md`.
- After every change, commit with a clear note describing what changed and what was done, then push to Git.
- Verify by building/running from Android Studio on the user's watch and phone.
